 ...
 */
public class App {
	private static EntityManagerFactory entityManagerFactory = Persistence.createEntityManagerFactory("com.jone.superapp.eclipselink-PU");
...
//    	findById();
    ...
    public static void getAllStudents() {
    	...
    	List<Student> reList = entityManager.createQuery("SELECT s FROM Student s", Student.class).getResultList();
    ...
    public static void getAllLecturers() {
    	...
    	List<Lecturer> result = entityManager.createQuery("SELECT l FROM Lecturer l", Lecturer.class).getResultList();//Lecturer là class, từ đó sinh ra object, class Lecturer đã được map thành
